...
-- Keymap for easy saving for my vscode habbit :(
vim.keymap.set("n", "<C-s>", ":w<CR>")
vim.keymap.set("n", "<C-q>", ":q<CR>")

-- Keymap for the navbuddy
vim.keymap.set("n", "<C-i>", ":Navbuddy<CR>")

-- Keyamps for the comment stuff
vim.keymap.set("v", "<C-_>", "<cmd> normal gcc<Cr>", { noremap = true, silent = true })
vim.keymap.set("v", "<C-/>", "<cmd> normal gcc<Cr>", { noremap = true, silent = true })
vim.keymap.set("n", "<C-_>", "<cmd> normal gcc<Cr>", { noremap = true, silent = true })
vim.keymap.set("n", "<C-/>", "<cmd> normal gcc<Cr>", { noremap = true, silent = true })
